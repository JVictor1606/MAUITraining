...
namespace AppShoppingCenter.Services
{
    public class StoreService
    {
        ...
        {
            return MockStoreService.GetStores();
        }
    }
    ...
    {
        public static List<Establishment> GetStores()
        {
            return new List<Establishment>
            {
                new Establishment
                {
                    Id = 1,
                    Name = "JEF",
                    Description = "Use sapatos com designs que acompanham o seu lifestyle. Compre Agora! Entrega em Todo Brasil. Sapatos com Frete Grátis. Boleto à Vista. 6x Cartão. Modelos: Mule Masculino, Oxford Masculino, Driver Masculino, Sneaker...",
                    Localization = "2 piso ao lado do Mateus",
                    Phone = "(98) 991165544",
                    Type = Models.Enums.EstablishmentType.Store,
                    Logo = "https://img.irroba.com.br/fit-in/600x600/filters:fill(transparent):quality(80)/estiloje/catalog/banners/logo-jef-maior.png",
                    Cover = "https://static.vecteezy.com/ti/vetor-gratis/p3/9601354-jef-circle-letter-logo-design-with-circle-and-ellipse-shape-jef-elipse-letters-with-typegraphic-style-the-three-initials-form-a-circle-logo-jef-circle-emblema-abstrato-monograma-letra-marca-vetor.jpg"
                 ...
                 new Establishment
                {
                    ...
                    Logo = "https://pbs.twimg.com/profile_images/934034343277793280/OVaWM7pH_400x400.jpg",
                ...
                new Establishment
                {
                    ...
                    Logo = "https://brasiliashopping.com.br/wp-content/uploads/2016/03/Brossman-2.png",
                ...
                new Establishment()
                {
                    ...
                    Logo = "https://w7.pngwing.com/pngs/689/177/png-transparent-oi-logo-tim-brasil-vivo-claro-%C5%9Earap-orange-broadband-telemar-norte-leste-sa.png",
                ...
                new Establishment()
                {
                    ...
                    Logo = "https://seeklogo.com/images/P/piticas-store-logo-DCCB688EE4-seeklogo.com.png",
                ...
                new Establishment()
                {
                    Id = 27,
                    Name = "MATEUS",
                    Description = "São 36 anos de história! Trajetória que teve início em Balsas, no Maranhão, em 1986. Com operações no varejo de supermercados, atacarejo, atacado, móveis e eletrodomésticos, e-commerce, indústria de panificação e central de fatiamento e porcionamento consolidamos nossa marca entre as maiores do país e a maior do Norte e Nordeste.",
                    Localization = "1 Andar - Loja 39 - Entrada Sul",
                    Phone = "(98) 3475-2789",
                    Type = EstablishmentType.Store,

                    Logo = "https://www.grupomateus.com.br/wp-content/uploads/2021/10/logo-mateus.png",
                    Cover = "https://braziljournal.com/wp-content/uploads/2023/08/Mateus.jpeg"
                },
